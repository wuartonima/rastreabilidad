...
namespace WindowsFormsApplication2
{
    class baseDatos
    {
        ...
        public string consultarDato(string tabladb, string tipodato, string valor,string condicion)
        {
            con.Open();
            string dato="";
        ...
        public void filtroetiqueta(DataGridView tabla, string tabladb, string etiqueta)
        {
            string consulta = "";
            con.Open();
            try
            {
                consulta = "SELECT * FROM " + tabladb + " WHERE codigobarras= " + "'" + etiqueta + "'" + ";";
